const EQUIPMENT = [
  {
    id: 'rolling-mill-main-drive-motor',
    backendId: 'rolling-mill-main-drive-motor',
    name: 'Rolling Mill Main Drive Motor',
    tag: 'rolling-mill-main-drive-motor',
    sensors: {
  ...
  {
    id: 'general-plant-motor',
    backendId: 'general-plant-motor',
    name: 'General Plant Motor',
    tag: 'general-plant-motor',
    sensors: {
  ...
  {
    id: 'industrial-induction-compressor-motor',
    backendId: 'industrial-induction-compressor-motor',
    name: 'Industrial Induction / Compressor Motor',
    tag: 'industrial-induction-compressor-motor',
    sensors: {
  ...
  {
    id: 'blower-large-motor-reference',
    backendId: 'blower-large-motor-reference',
    name: 'BF Blower / Large Motor',
    tag: 'blower-large-motor-reference',
    sensors: {
